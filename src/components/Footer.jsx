...
const Footer = () => {
  return (
    <footer className="bg-slate-900 dark:bg-slate-950 text-slate-300 border-t border-slate-800 pt-16 pb-8 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-white text-base font-bold mb-6 relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-10 after:bg-gold-500 pb-2">
              Quick Links
            </h3>
            <ul className="space-y-3 text-sm">
              {[
                ...
                <li key={link.name}>
                  <Link href={link.path} className="hover:text-gold-500 transition-colors flex items-center group text-slate-400 hover:translate-x-1 duration-200">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+919000000000" className="hover:text-gold-500 transition-colors">+91 900 000 0000</a>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-gold-500 mr-3 shrink-0" />
                <a href="mailto:info@rudragroup.com" className="hover:text-gold-500 transition-colors">info@rudragroup.com</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              ...
              <li className="flex items-center">
                <Clock className="h-5 w-5 text-slate-600 mr-3 shrink-0" />
                <div>
